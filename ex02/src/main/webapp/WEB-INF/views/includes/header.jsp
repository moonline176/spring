	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand"  href="/app2">SB Admin v2.0</a>
			</div>
			<!-- /.navbar-header -->
			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a href="/app2/board/list"><i
								class="fa fa-table fa-fw"></i>게시판</a></li>
						<li><a href="/app2/employee/elist"><i
								class="fa fa-table fa-fw"></i>employee</a></li>
